...
import com.example.wika_runungan.databinding.FragmentKabanataFragmentsBinding
import java.util.*
import kotlin.collections.ArrayList


class KabanataFragments : Fragment() {
    private lateinit var binding: FragmentKabanataFragmentsBinding
    lateinit var adapter : NoliAdapter
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        binding = FragmentKabanataFragmentsBinding.inflate(layoutInflater)
